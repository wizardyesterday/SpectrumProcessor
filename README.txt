...
This particalar app accepts IQ data from stdin and allows computes spectral
powr over a specified two-spectral bandwidth about center frequency. This
...
versus control voltage that drives the IF gain of the R82xx device.
